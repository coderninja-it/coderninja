        ...
        c = {
            ...
            touch: function() {
                var b, f, k, d, c, e, m = !1,
                    ...
                    q = 0,
                    s = 0;
                if (v) g.style.msTouchAction = "none", g._gesture = new MSGesture, g._gesture.target = g, g.addEventListener("MSPointerDown", function(b) {
                    b.stopPropagation();
                ...
                }, !1), g._slider = a, g.addEventListener("MSGestureChange", function(a) {
                    a.stopPropagation();
                ...
                }, !1), g.addEventListener("MSGestureEnd", function(a) {
                    a.stopPropagation();
                    ...
                    var t = function(h) {
                            g.removeEventListener("touchmove", u, !1);
                            if (a.animatingTo === a.currentSlide && !m && null !== c) {
                                h = n ? -c : c;
                            ...
                            g.removeEventListener("touchend", t, !1);
                            k = c = f = b = null
                        },
                        u = function(g) {
                            l = g.touches[0].pageX;
                    ...
                    g.addEventListener("touchstart", function(c) {
                        if (a.animating) c.preventDefault();
                        else if (window.navigator.msPointerEnabled || 1 === c.touches.length) a.pause(), d = p ? a.h : a.w, e = Number(new Date), l = c.touches[0].pageX, q = c.touches[0].pageY, k = h && n && a.animatingTo === a.last ? 0 : h && n ? a.limit - (a.itemW + a.vars.itemMargin) * a.move * a.animatingTo : h && a.currentSlide === a.last ? a.limit : h ? (a.itemW + a.vars.itemMargin) * a.move * a.currentSlide : n ? (a.last - a.currentSlide + a.cloneOffset) * d : (a.currentSlide + a.cloneOffset) * d, b = p ? q : l, f = p ? l : q, g.addEventListener("touchmove", u, !1), g.addEventListener("touchend", t, !1)
                    }, !1)
                }
            },
            resize: function() {
